...
const languages = [
  ...
  'Portuguese', 'Russian', 'Arabic', 'Hindi', 'Bengali', 'Punjabi', 'Javanese', 'Malay'
];
...
export default function UpdateUserPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 -mt-16">
      <motion.div
      ...
      >
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Update Your Travel Profile</h1>
          <p className="text-gray-400 text-lg">Keep your profile up to date to find the best travel matches</p>
        </div>
